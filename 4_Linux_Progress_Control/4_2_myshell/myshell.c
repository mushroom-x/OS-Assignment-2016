...
/*
*  FUNCTION
* 	 check if the command is validate and get cmd Index
* PARAM
*	cmd [string ] command line
*  RETURN 
*	-1	: invalid
* 	else	: index of cmdCollection
*/
...
/*
* FUNCTION
*	run the command with current command index
* PARAM
...
int main()
{
	...
	int cmdIndex;
	// TODO It's not a good way -->sleep waiting
	while(TRUE)
	{
		...
		wait(0);		//TODO
		printf("-------F :  waiting for next  command -------\n");
	}
}